...
<body>
    <table style="width: 100%; max-width: 600px; margin: 0 auto; padding: 20px; border-collapse: collapse; border: 1px solid #ccc;">
        ...
        <tr>
            <td>
                <p>Dear {{ $user->name }},</p>
                <p>We wanted to inform you that your order number {{ $order->id }} is currently being processed. We appreciate your business and will keep you updated on the progress.</p>
